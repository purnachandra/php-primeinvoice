...
class Portlet extends CWidget
{
	...
	public function init()
	{
		...
		if($this->title!==null) {
			...
			echo "  <div class=\"expandButton\" style=\"width:18px;height:18px;top:-3px;right:4px;background-image:url(".Yii::app()->request->baseUrl."/systemImages/widgetCollapseIcon.png);background-repeat:no-repeat;position:absolute;\" class=\"expandButton\"></div></div>\n";
		}
